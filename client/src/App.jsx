      ...
      {!showNamePopup && (
        <div className="w-full max-w-2xl h-[90vh] bg-white rounded-xl shadow-md flex flex-col overflow-hidden">
          ...
          <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
            ...
            {/* <div className='bg-red-400 py-1 px-2 rounded text-white font-semibold hover:bg-red-500'>
              <button
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-zinc-100 flex flex-col">
            {messages.map((m) => {
              ...
              const avatar = m.sender.charAt(0).toUpperCase();
              ...
              return (
                ...
                >
                  ...
                  {/* Avatar (only show for others, optional) */}
                  {!mine && (
                    <div className="w-6 h-6 rounded-full bg-gray-300 flex items-center justify-center text-sm font-semibold">
                      {avatar}
                    </div>
                  )}
                  ...
                  {mine && (
                    <div className="w-8 h-8 rounded-full bg-green-400 flex items-center justify-center text-sm font-semibold text-white">
                      {avatar}
                    </div>
                  )}
